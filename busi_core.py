"""
Core model-loading and inference logic for the BUSI breast-ultrasound demo.
Mirrors busi-complete-run.ipynb exactly:
  - Same architectures (Part 3 / Part 4)
  - Same preprocessing (Cell 12: clf_eval_tf / seg_eval_tf)
  - Same class order (Cell 1.1: CLASS_NAMES = benign, malignant, normal)
...
DISPLAY_NAMES = {"benign": "Benign", "malignant": "Malignant", "normal": "Normal"}
